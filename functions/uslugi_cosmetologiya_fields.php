	...
	function extra_fields_cosmetologiya_func( $post ){
		...
		<div class="admblock">
			...
			<div class="item">
				...
				<?php upload_image('20','img_cosmetologiya_bg','Выберите картинку фона'); ?>
			</div>
			<div class="two_items">
				<div class="item">
					<?php upload_image('21','img_cosmetologiya_block1_bg','Выберите картинку фона блока'); ?>
					<p><b>Заголовок</b></p>
			...
			<div class="two_items">
				<div class="item">
					<?php upload_image('22','img_cosmetologiya_block2_bg','Выберите картинку фона блока'); ?>
					<p><b>Заголовок</b></p>
			...
			<div class="two_items">
				<div class="item">
					<?php upload_image('23','img_cosmetologiya_block3_bg','Выберите картинку фона блока'); ?>
					<p><b>Заголовок</b></p>
			...
			<div class="two_items">
				<div class="item">
					<?php upload_image('24','img_cosmetologiya_block4_bg','Выберите картинку фона блока'); ?>
					<p><b>Заголовок</b></p>
				...
				<div class="item">
					<?php
						$settings = array(
							'textarea_name'	=>	'extra[cosmetologiya_content_block4]',
							'dfw'		=>	true,
							'quicktags'	=>	false
						);
						wp_editor( get_post_meta($post->ID, 'cosmetologiya_content_block4', true), 'truewpeditor4', $settings );
					?>
				</div>
			</div>
			<?php
				$settings = array(
					'textarea_name'	=>	'extra[cosmetologiya_content_block5]',
					'dfw'		=>	true,
					'quicktags'	=>	false
				);
				wp_editor( get_post_meta($post->ID, 'cosmetologiya_content_block5', true), 'truewpeditor5', $settings );
			?>
		</div>
		<input type="hidden" name="extra_fields_nonce" value="<?php echo wp_create_nonce(__FILE__); ?>" />
		<?
	}
	add_action( 'save_post', 'my_extra_fields_cosmetologiya_update', 0 );
	function my_extra_fields_cosmetologiya_update( $post_id ){
	    // базовая проверка
	    if (
	        empty( $_POST['extra'] )
